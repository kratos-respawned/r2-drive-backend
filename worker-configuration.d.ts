/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 94c0e5c2605446bbeba34e7ad8dec67a)
// Runtime types generated with workerd@1.20260120.0 2026-01-24 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		kv_r2_drive: KVNamespace;
		r2_drive: R2Bucket;
		db_r2_drive: D1Database;
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		ORIGIN_URL: string;
		ACCOUNT_ID: string;
		BUCKET_NAME: string;
		R2_ACCESS_ID_KEY: string;
		R2_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "ORIGIN_URL" | "ACCOUNT_ID" | "BUCKET_NAME" | "R2_ACCESS_ID_KEY" | "R2_SECRET" | "RESEND_SECRET">> {}
}
